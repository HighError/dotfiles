menu(type='*' where=(sel.count or wnd.is_taskbar or wnd.is_edit) title='Термінали' sep=sep.top image=icon.run_with_powershell)
{
	$tip_run_admin=["\xE1A7 Натисніть SHIFT, щоб запустити " + this.title + " від імені адміністратора", tip.warning, 1.0]
